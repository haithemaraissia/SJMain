<%@ Page CodeFile="RecoverPassword.aspx.cs" Title="" Language="C#" MasterPageFile="~/NotAuthenticated/Plain.master"
    AutoEventWireup="true" CodeBehind="RecoverPassword.aspx.cs" Inherits="Account.RecoverPassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:PasswordRecovery ID="PasswordRecovery1" runat="server" BorderColor="#E6E2D8"
        BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Size="Large" Width="100%"
