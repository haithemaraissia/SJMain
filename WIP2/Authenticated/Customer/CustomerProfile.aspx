...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        height: 108px">--%>
                    ...
                    <tr>
                        <td>
                            <table align="center">
                                <tr>
                                    <td>
                                        <div id="WelcomeCustomerHeader" style="height: 15px; left: 745px; position: relative; text-align: center; top: 5px; width: 230px; z-index: 0;">
                                ...
                                <tr>
                                    <td>
                                        <cc1:TabContainer ID="ProfileTabContainer" CssClass="opera" runat="server" ActiveTabIndex="9"
                                            ...
                                            <cc1:TabPanel ID="EventTabPanel" runat="server" HeaderText="<%$ Resources:Resource, EventTabPanel %>">
                                                <ContentTemplate>
                                                    <table style="height: 98%; position: relative; width: 100%;">
                                                        <tr>
                                                            <td style="vertical-align: top; width: 50%;">
                                                                <asp:Label ID="StatusLabel" runat="server" Style="left: 10px; position: relative; top: 10px" Text="<%$ Resources:Resource, Status %>" Font-Bold="True" ForeColor="#400000"
                                                                ...
                                                                <asp:DataList ID="StatusDataList" runat="server" DataKeyField="CustomerID" DataSourceID="StaticObjectDataSource"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:Panel ID="StatusPanel" runat="server" Height="560px" Style="left: 10px; position: relative; top: 10px" Width="375px">
                                                                            <table style="height: 100%; left: 0px; position: relative; text-align: center; top: 0px; vertical-align: middle; width: 100%;">
                                                                                <tr>
                                                                                    <td style="height: 16%; width: 100px;">
                                                            ...
                                                            <td style="vertical-align: top; width: 49%">
                                                                <asp:Label ID="PerformanceIDLabel" runat="server" Style="left: 23px; position: relative; top: 12px;" Text="<%$ Resources:Resource, EventPerformance %>" Font-Names="Times New Roman"
                                                                           Font-Bold="True" ForeColor="#003300" Height="23px" Font-Size="Medium"></asp:Label><asp:Panel
                                                                                                                                                                 ID="PerformancePanel" runat="server" Height="560px" Style="left: 23px; overflow: hidden; position: relative; top: 12px;" Width="355px">
                                                                                                                                                                 <table style="height: 350px; left: 4px; position: relative; text-align: center; top: 0px; vertical-align: middle; width: 100%;">
                                                                                                                                                                     <tr>
                                                                                                                                                                         <td>
                                            ...
                                            <cc1:TabPanel ID="ProfileTabPanel" runat="server" HeaderText="<%$ Resources:Resource, ProfileTabPanel %>">
                                                <ContentTemplate>
                                                    <table style="height: 80%; padding-top: 30px; position: relative; vertical-align: middle; width: 100%;" align="center">
                                                        <tr align="center">
                                                            <td style="background-color: #ffffff; height: 630px; width: 160px;" rowspan="2">
                                                                <asp:Panel ID="CustomerPhotoPanel" runat="server">
                                                                    <asp:FormView ID="CustomerPhotoFormView" runat="server" DataKeyNames="PhotoID" DataSourceID="CustomerPhotoObjectDataSource"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:ImageButton ID="CustomerImageButton" runat="server" Height="385px" Style="position: relative; top: 0px; z-index: 100;" Width="350px" CommandName="select" ImageUrl='<%#Eval("PhotoPath")%>' />
                                                                            <br />
                                                                            <br />
                                                                            <br />
                                                                            <table align="center" style="position: relative; right: 10px; width: 150px;">
                                                                                <tr>
                                                                                    <td>
                                                                                        <div>
                                                            ...
                                                            <td style="height: 630px; width: 100px;" rowspan="2" id="Td2">
                                                                <asp:UpdatePanel ID="CustomerDetailUpdatePanel" runat="server" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        <asp:Panel ID="CustomerDetailProfilePanel" runat="server" Height="347px" Style="height: 375px; left: 445px; overflow: hidden; top: 47px; z-index: 103;" Width="300px" BackColor="White">
                                                                ...
                                                                <asp:Panel ID="ProfileChangePasswordPanel" runat="server" CssClass="BlueMenublock"
                                                                           Height="26px" Style="height: 26px; left: 509px; top: 450px; width: 151px; z-index: 113;"
                                                                           Font-Size="10pt">
                                                                    <ul>
                                                                        <li>
                                            ...
                                            <cc1:TabPanel ID="PortfolioTabPanel" runat="server" HeaderText="<%$ Resources:Resource, PortfolioTabPanel %>">
                                                <ContentTemplate>
                                                    <asp:Panel ID="PortfolioPanel" runat="server" Style="height: 100%; position: relative; width: 660px; z-index: 100">
                                                        <asp:UpdatePanel ID="CustomerPortfolioUpdatePanel" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:DataList ID="PortfolioDataList" runat="server" DataKeyField="CustomerID" DataSourceID="CustomerPortfolioDataSource"
                                                                              Style="height: 557px; left: 0px; position: absolute; top: 20px; width: 634px;">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="AboutMeLabel" runat="server" Font-Bold="True" ForeColor="White" Style="left: 10px; position: absolute; top: 18px; z-index: 1;" Text="<%$ Resources:Resource, About %>" BorderColor="#336699"
                                                                                   BorderStyle="Outset" BorderWidth="3px" Font-Size="Small" BackColor="#003366">
                                                                        </asp:Label>
                                                                        <asp:Label ID="ModifiedLabel" runat="server" Font-Bold="True" Style="height: 18px; left: 76px; position: absolute; top: 23px; width: 655px;" Text="<%$ Resources:Resource, ModifiedLabel %>"
                                                                                   Visible='<%#Eval("Modified")%>' ForeColor="Maroon"></asp:Label>
                                                                        <asp:Panel ID="AboutPanel" runat="server" Height="171px" Style="left: 50px; overflow: hidden; position: absolute; top: 55px;" Width="535px" Wrap="False">
                                                                            <asp:TextBox ID="AboutTextBox" runat="server" Height="162px" Style="left: 2px; position: relative; top: 1px;" TextMode="MultiLine" Width="526px" MaxLength="1000" Text='<%#Eval("About", "{0}")%>'
                                                                                         onKeyDown="CountLeft(this.value,this.value.length,1000,'LeftAboutLabel');" onKeyUp="CountLeft(this.id,this.value.length,1000,'LeftAboutLabel');"></asp:TextBox><asp:Panel
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            <input id="LeftAboutLabel" style="color: #000080; position: absolute; top: 195px; width: 35px;"
                                                                                                                                                                                                                                                                   type="text" value="1000" />
                                                                                                                                                                                                                                                            <asp:Label ID="CharactersLeftAboutLabel" runat="server" Text="<%$ Resources:Resource, CharactersLeftLabel %>"
                                                                                                                                                                                                                                                                       ForeColor="#000066" Width="200px" Style="left: 42px; position: absolute; top: 197px;"></asp:Label>
                                                                                                                                                                                                                                                        </asp:Panel>
                                                                        </asp:Panel>
                                                                        <asp:Label ID="SpecialNotesLabel" runat="server" Font-Bold="True" ForeColor="White"
                                                                                   Style="left: 8px; position: absolute; top: 300px; z-index: 1;" Text="<%$ Resources:Resource, PortfolioSpecialNotes %>"
                                                                        ...
                                                                        <asp:Panel ID="SpecialNotesPanel" runat="server" Style="height: 205px; left: 50px; position: absolute; top: 344px; width: 533px; z-index: 1;" Width="533px">
                                                                            <asp:TextBox ID="SpecialNotesTextBox" runat="server" Height="162px" Style="height: 195px; left: 3px; position: absolute; top: 1px; width: 520px;" TextMode="MultiLine" MaxLength="1000"
                                                                            ...
                                                                            <asp:Panel ID="CharacterLeftSpecialNotesPanel" runat="server" Height="28px" Width="131px">
                                                                                <input id="LeftSpecialNotesLabel" style="color: #000080; position: absolute; top: 230px; width: 35px;" type="text" value="1000" />
                                                                                <asp:Label ID="CharacterLeftSpecialNotesLabel" runat="server" Text="<%$ Resources:Resource, CharactersLeftLabel %>"
                                                                                           ForeColor="#000066" Width="200px" Style="left: 42px; position: absolute; top: 232px;"></asp:Label>
                                                                            </asp:Panel>
                                                                        </asp:Panel>
                                                                ...
                                                                <asp:LinkButton ID="UpdatePortfolioLinkButton" runat="server" Font-Bold="True" ForeColor="Maroon"
                                                                                CssClass="UnderlineLink" Style="height: 15px; left: 656px; position: absolute; top: 599px; width: 50px" CausesValidation="False" OnClick="UpdatePortfolioLinkButton_Click"
                                                                ...
                                                                <asp:LinkButton ID="CancelPortfolioLinkButton" runat="server" Font-Bold="True" ForeColor="Maroon"
                                                                                CssClass="UnderlineLink" Style="height: 15px; left: 725px; position: absolute; top: 599px; width: 50px" CausesValidation="False" OnClientClick="FireAnimation();"
                                                    ...
                                                    <asp:Panel ID="FilterationPanel" runat="server" Width="173px" Height="80px" Style="left: 615px; overflow: hidden; position: relative; text-align: center; top: 70px;" BackColor="White">
                                                        <table cellspacing="1" style="height: 100%; width: 100%;">
                                                            <tr>
                                            ...
                                            <cc1:TabPanel ID="MessageTabPanel" runat="server" HeaderText="<%$ Resources:Resource, MessageTabPanel %>">
                                                <ContentTemplate>
                                                    <table style="height: 660px; position: relative; width: 100%;">
                                                        <tr>
                                                            <td rowspan="2" style="background-color: gainsboro; text-align: center; vertical-align: top; width: 95px;">
                                                            ...
                                                            <td style="background-color: White; height: 300px; width: 100px;" valign="top">
                                                                <asp:Panel ID="UpperMessagePanel" runat="server" Height="300px" Width="680px" Style="background-color: #EFE7A7; overflow: hidden; z-index: 111;">
                                                                    <asp:UpdatePanel ID="UpperMessageUpdatePanel" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            <asp:GridView ID="MessageGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                                          ...
                                                                                          AllowSorting="True" Style="left: 1px; position: relative; top: 0px; width: 678px;"
                                                                                          GridLines="None" BackColor="white" BorderColor="#DEDFDE" BorderWidth="0px" CellPadding="4"
                                                                                          OnRowDataBound="MessageGridView_RowDataBound" OnPreRender="MessageGridViewPreRender"
                                                                ...
                                                                <asp:UpdatePanel ID="CustomMessageMenuUpdatePanel" runat="server" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        <asp:Panel runat="server" ID="CustomMessageMenuPanel" Height="28px" Style="height: 28px; text-align: center; top: 332px; vertical-align: bottom; width: 680px;" align="center"
                                                                                   Width="100%">
                                                        ...
                                                        <tr>
                                                            <td style="background-color: #FFFFFF; height: 287px; width: 100px;">
                                                                <asp:UpdatePanel ID="LowerMessageUpdatePanel" runat="server" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        <asp:Panel ID="LowerMessagePanel" runat="server" BackColor="White" Style="display: block; max-width: 680px; overflow: hidden; position: relative; white-space: normal; width: 682px; z-index: 1;">
                                                                            <asp:DetailsView ID="DetailsMessageView" runat="server" Height="255px" Style="left: 1px; position: relative; top: 0px; vertical-align: top; width: 655px;" AutoGenerateRows="False"
                                                                                ...
                                                                                <Fields>
                                                                                    <asp:TemplateField>
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="MessageDescriptionHeader" runat="server" Style="position: relative; top: 3px; z-index: 1;" Text="<%$ Resources:Resource, DescriptionLabel %>" Font-Bold="True"
                                                                                            ...
                                                                                            <asp:Label ID="MessageDescription" runat="server" Text='<%#Bind("Description", "{0}")%>'
                                                                                                       Width="655px" Style="display: block; max-width: 655px; white-space: normal; width: 655px;"
                                            ...
                                            <cc1:TabPanel ID="ProjectTabPanel" runat="server" HeaderText="<%$ Resources:Resource, ProjectTabPanel %>">
                                                <ContentTemplate>
                                                    <asp:Panel ID="ProjectPanel" runat="server" BackColor="White" Height="150%" Style="height: 292px; left: 0px; position: relative; top: 1px;" Width="100%">
                                                        ...
                                                        <asp:Panel ID="PanelAddProject" runat="server" CssClass="BlueMenublock" Height="16px"
                                                                   Style="left: 333px; position: absolute; top: 293px; z-index: 100;" Width="130px"
                                                                   Font-Size="10pt">
                                                            <ul>
                                                                <li>
                                                    ...
                                                    <asp:Panel ID="DetailProjectPanel" runat="server" BackColor="White" Height="150%"
                                                               Style="height: 296px; left: -3px; overflow: hidden; position: relative; top: 25px;"
                                                               Width="100%">
                                                        <table style="height: 66%; left: 2px; position: relative; top: 13px; width: 98%;">
                                                            <tr>
                                                                <td style="background-color: white; height: 91%; vertical-align: middle; width: 29%;"
                                                                    rowspan="1">
                                                                    <asp:UpdatePanel ID="DetailProjectSpecificationUpdatePanel" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            <asp:Panel ID="DetailProjectSpecificationPanel" runat="server" Style="height: 181px; left: 10px; position: absolute; top: 42px; width: 244px; z-index: 1;">
                                                                                <asp:FormView ID="DetailProjectSpecificationFormView" runat="server" DataKeyNames="ProjectID"
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <div style="background-color: SlateGray; border-left: 4px solid SlateGray; border-right: 4px solid SlateGray; font-size: 1px; height: 1px; margin-left: 4px; margin-right: 2px; overflow: hidden;">
                                                                                        </div>
                                                                                        <div style="background-color: SlateGray; border-left: 1px solid SlateGray; border-right: 1px solid SlateGray; font-size: 1px; height: 1px; margin-left: 3px; margin-right: 1px; overflow: hidden;">
                                                                                        </div>
                                                                                        <div style="background-color: SlateGray; border-left: 1px solid SlateGray; border-right: 1px solid SlateGray; font-size: 1px; height: 1px; margin-left: 2px; margin-right: 0px; overflow: hidden;">
                                                                                        </div>
                                                                                        <div style="background-color: SlateGray; border-left: 1px solid SlateGray; border-right: 1px solid SlateGray; font-size: 1px; height: 1px; margin-left: 1px; margin-right: -1px; overflow: hidden;">
                                                                                        </div>
                                                                                        <div style="background-color: SlateGray; border-left: 1px solid SlateGray; border-right: 1px solid SlateGray; font-size: 1px; height: 1px; margin-left: 1px; margin-right: -1px; overflow: hidden;">
                                                                                        </div>
                                                                                        <div style="background-color: SlateGray; border-left: 1px solid SlateGray; border-right: 1px solid SlateGray; font-size: 1px; height: 1px; margin-left: 0px; margin-right: -2px; overflow: hidden;">
                                                                                        </div>
                                                                                        <div style="background-color: SlateGray; border-left: 1px solid SlateGray; border-right: 1px solid SlateGray; font-size: 1px; height: 1px; margin-left: 0px; margin-right: -2px; overflow: hidden;">
                                                                                        </div>
                                                                                        <table cellspacing="0" border="0" style="border-collapse: collapse; border-left: 1px solid SlateGray; border-right: 1px solid SlateGray; border-style: none solid; overflow: auto; width: 100%;">
                                                                                            <tr>
                                                                                                <td style="width: 100px">
                                                                                        ...
                                                                                        <div style="background-color: SlateGray; border-left: 1px solid SlateGray; border-right: 1px solid SlateGray; font-size: 1px; height: 1px; margin-left: 8px; margin-right: 6px; overflow: hidden;">
                                                                                        </div>
                                                                                    </ItemTemplate>
                                                                ...
                                                                <td style="background-color: white; height: 91%; text-align: right; vertical-align: middle; width: 31%;">
                                                                    <asp:UpdatePanel ID="DetailProjectPhotoUpdatePanel" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            <asp:FormView ID="DetailProjectPhotoFormView" runat="server" DataKeyNames="PhotoID"
                                                                                          DataSourceID="ProjectPhotoDetailDataSource" Style="height: 161px; left: 255px; position: absolute; top: 43px; width: 254px; z-index: 2;" Width="290px" AllowPaging="True">
                                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:UpdatePanel ID="DetailProjectStatusUpdatePanel" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            <asp:DetailsView ID="DetailProjectStatusDetailView" runat="server" AutoGenerateRows="False"
                                                                                             DataSourceID="ProjectExtraDataSource" Height="201px" Style="height: 201px; left: 550px; position: absolute; top: 45px; width: 221px; z-index: 3;" Width="221px"
                                            ...
                                            <cc1:TabPanel ID="FavoriteTabPanel" runat="server" HeaderText="<%$ Resources:Resource, FavoriteTabPanel %>">
                                                <ContentTemplate>
                                                    <table style="height: 100%; left: 0px; position: relative; top: 0px; width: 100%;">
                                                        <tr>
                                                            <td style="height: 154px; text-align: center; vertical-align: top;">
                                                                <asp:Panel ID="FavoritePanel" runat="server" Height="642px" Style="left: 0px; overflow: hidden; position: relative; top: 0px" Width="100%">
                                                                            ...
                                                                            <asp:GridView ID="FavoriteGridView" runat="server" AllowPaging="True" AllowSorting="True"
                                                                                    ...
                                                                                    <asp:TemplateField>
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:LinkButton ID="DeleteFavoriteLinkButton1" runat="server" BackColor="#284775"
                                                                                                            ...
                                                                                                            ForeColor="White" Style="left: 0px; position: relative; text-align: center; top: 0px;"
                                                                                    ...
                                                                                    <asp:TemplateField>
                                                                                        <ItemTemplate>
                                                                                            ...
                                                                                            <asp:HyperLink ID="ViewProfileLinkButton1" runat="server" BackColor="#400000" CausesValidation="False"
                                                                                                           Font-Bold="True" Font-Size="10pt" ForeColor="White" Style="position: relative; text-align: center;" Width="102px" NavigateUrl='<%#Eval("ProID", "../ViewProfessionalProfile.aspx?PID={0}")%>'
                                                                                ...
                                                                                <EmptyDataTemplate>
                                                                                    <asp:Label ID="EmptyFavoriteLabel" runat="server" BackColor="#666666" Font-Bold="True"
                                                                                               ...
                                                                                               Width="100%" Style="height: 28px; left: 0px; position: absolute; text-align: center; top: 5px; vertical-align: top"></asp:Label>
                                                                                </EmptyDataTemplate>
                                            ...
                                            <cc1:TabPanel ID="InvitationTabPanel" runat="server" HeaderText="<%$ Resources:Resource, InvitationTabPanel %>">
                                                <ContentTemplate>
                                                    <asp:Panel ID="InvitationPanel" runat="server" Height="655px" Style="left: 0px; overflow: hidden; position: relative; top: 0px" Width="100%">
                                            ...
                                            <cc1:TabPanel ID="WatchListTabPanel" runat="server">
                                                ...
                                                <ContentTemplate>
                                                    <asp:Panel ID="WatchListPanel" runat="server" Height="649px" Style="overflow: hidden; position: relative; top: 0px;" BackColor="White">
                                            ...
                                            <cc1:TabPanel ID="TransactionTabPanel" runat="server" HeaderText="<%$ Resources:Resource, Transaction %>">
                                                <ContentTemplate>
                                                    <asp:Panel ID="ActiveTransactionPanel" runat="server" Height="200px" Style="left: 0px; position: relative; top: 0px" Width="100%" BackColor="White">
                                                    ...
                                                    <asp:Panel ID="TransactionProgressPanel" runat="server" Height="200px" Style="left: 0px; position: relative; top: 34px" Width="100%" BackColor="White">
                                                    ...
                                                    <asp:Panel ID="TransactionHistoryPanel" runat="server" Height="200px" Style="left: 0px; position: relative; top: 52px" Width="100%" BackColor="White">
                                            ...
                                            <cc1:TabPanel ID="ContractTabPanel" runat="server" HeaderText="<%$ Resources:Resource, Contract %>">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:ObjectDataSource ID="CustomerContractGeneralObjectDataSource" runat="server"
                                                                          ...
                                                                          TypeName="CustomerContractTableAdapters.CustomerContractGeneralTableAdapter">
                                                        <SelectParameters>
                                                            <asp:SessionParameter Name="CustomerID" SessionField="CustomerId" />
                                                        </SelectParameters>
                                                    </asp:ObjectDataSource>
                                                        ...
                                                        <asp:UpdatePanel ID="DetailContractUpdatePanel" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:FormView ID="DetailContractFormView" runat="server" DataSourceID="CustomerContractDetailObjectDataSource"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <table style="height: 219px; position: relative; width: 100%;">
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td style="background-color: #660000; width: 100px;">
                                                                                ...
                                                                                <td colspan="3" rowspan="4">
                                                                                    &nbsp;&nbsp;<asp:TextBox ID="DescriptionTextBox" runat="server" Height="145px" Style="position: relative; top: -1px" Text='<%#Bind("Description", "{0}")%>' Width="374px"></asp:TextBox>&#160;&nbsp;
                                                                                </td>
                                                                                <td style="text-align: center; width: 100px;">
                                                                                </td>
                                                                            </tr>
                                            ...
                                            <cc1:TabPanel ID="CommentTabPanel" runat="server" HeaderText="<%$ Resources:Resource, CommentTabPanel %>">
                                                <ContentTemplate>
                                                                ...
                                                                <td rowspan="2">
                                                                    <asp:GridView ID="CommentSummaryGridView" runat="server" AutoGenerateColumns="False"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField>
                                                                                <ItemTemplate>
                                                                                    <table style="height: 160px; width: 249px;" cellpadding="8" cellspacing="0">
                                                                                        <tr>
                                                                                            <td>
                                                    ...
                                                    <asp:Panel ID="CommentReceivedPanel" runat="server" Height="440px" Style="left: 0px; overflow: hidden; position: relative; top: 10px" Width="100%">
                                                    ...
                                                    <asp:Panel ID="CommentSentPanel" runat="server" Height="440px" Style="left: 0px; overflow: hidden; position: relative; top: 50px" Width="100%" BackColor="White">
                                            ...
                                            <cc1:TabPanel ID="AccountTabPanel" runat="server" HeaderText="<%$ Resources:Resource, AccountTabPanel %>">
                                                <ContentTemplate>
                                                    <table style="height: 100%; position: relative; width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td colspan="3">
                                                                <asp:TextBox ID="AccountCustomerServiceMessageTextBox" runat="server" Height="400px"
                                                                             ...
                                                                             onKeyUp="CountLeft(this.id,this.value.length,1000,'LeftLabel');"></asp:TextBox><asp:Panel
                                                                                                                                                                ...
                                                                                                                                                                <input id="LeftLabel" style="color: #000080; width: 35px;" type="text" value="1000" /><asp:Label
            ...
            <asp:Panel ID="DetailTransaction" runat="server" Height="150px" Style="display: block; left: 91px; position: relative; text-align: center; top: 308px; z-index: 103;"
            ...
            <asp:Panel ID="MethodofPaymentPanel" runat="server" Height="192px" Style="display: block; left: 91px; position: relative; top: 471px; z-index: 103;" Width="512px" BackColor="White">
                <asp:UpdatePanel ID="MethodofPaymentUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="CreditCardPanel" runat="server" Style="left: 2px; position: relative; top: 13px;" Height="120%" Width="98%">
                            <div style="text-align: center">
                                <table style="height: 100%; left: 0px; position: relative; top: 0px; width: 98%;">
                                    <tr>
                                        <td style="width: 100px">
                                ...
                                <td style="width: 100px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right; width: 100px;">
                                            <asp:Button ID="CancelPayment" runat="server" Style="left: 0px; position: relative; top: 22px;" Text="<%$ Resources:Resource, Cancel %>" OnClick="CancelPayment_Click"
            ...
            <p>
                <asp:GridView ID="ProjectCurrentStatusGridView" runat="server" DataSourceID="CustomerBidObjectDataSource"
                              Style="position: relative; text-align: center; vertical-align: middle;" AutoGenerateColumns="False"
                              ShowHeader="False" GridLines="None" Width="50%">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <table style="height: 113%; left: 0px; position: relative; text-align: center; top: 4px; vertical-align: middle; width: 80%;" cellspacing="0">
                                    <tr>
                                        <td style="background-color: #5d7b9d; height: 26px; width: 25%;">
                                            <asp:Label ID="ProjectIDLabel" runat="server" Style="position: relative" Text="<%$ Resources:Resource, ProjectIDLabel %>"
                                                       Font-Bold="True" ForeColor="White"></asp:Label>
                                        </td>
                                        <td style="height: 26px; width: 83px;">
                                            &nbsp;
                                            <asp:Label ID="ProjectIDValue" runat="server" Style="left: 31px; position: relative; top: -6px;" Text='<%#Bind("ProjectID", "{0}")%>' Height="19px" Width="53px"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 83px">
                                            &nbsp;
                                            <asp:Label ID="BidderValue" runat="server" Style="left: 30px; position: relative; top: -5px;" Text='<%#Bind("HighestBidUsername", "{0}")%>' Height="19px" Width="53px"
                                    ...
                                    <tr>
                                        <td style="background-color: #5d7b9d; height: 35px; width: 25%;">
                                        ...
                                        <td style="height: 35px; width: 83px;">
                                            &nbsp;
                                            <asp:Label ID="HighestBidValue" runat="server" Style="left: 34px; position: relative; top: -3px;" Text='<%#Bind("HighestBid", "{0}")%>' Height="19px" Width="61px"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </ItemTemplate>
        ...
        <asp:ObjectDataSource ID="CustomerContractDescriptionObjectDataSource" runat="server"
            ...
            <asp:Panel ID="GlobalChangePasswordPanel" runat="server" Style="display: none; left: 199px; position: absolute; top: 921px; z-index: 100;" Width="400px" Height="266px"
                ...
                <asp:Panel ID="ChangePasswordPanel" runat="server" Height="266px" Width="320px" BackColor="Silver"
                    ...
                    <asp:ChangePassword ID="ChangePassword" runat="server" BackColor="Silver" Height="103px"
                                        Width="316px">
                        <SuccessTemplate>
                            <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse; width: 305px;">
                                <tr>
                                    <td style="height: 105px">
                                        <table border="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td style="height: 38px; text-align: center; width: 300px;">
                                        ...
                                        <asp:Button ID="ContinuePushButton" runat="server" CausesValidation="False" CommandName="Continue"
                                                    Text="<%$ Resources:Resource, Continue %>" Width="100px" Style="left: 202px; position: absolute; top: 80px; z-index: 100;" />
                                    </td>
                                </tr>
                            </table>
                        </SuccessTemplate>
            ...
            <asp:Panel ID="ProfileSlideShowPanel" runat="server" Style="background-color: #D2B48C; display: none; left: 189px; position: relative; top: 664px; z-index: 100;" Height="374px"
                ...
                &nbsp; &nbsp;
                <asp:Image ID="ProfileImage" runat="server" Height="243px" Style="left: 60px; position: absolute; top: 44px" Width="364px" />
                <br />
                <asp:Button ID="ProfileImagePreviousButton" runat="server" Style="left: 81px; position: absolute; top: 299px" Text="<%$ Resources:Resource, Previous %>" Width="90px" />
                &nbsp;
                <asp:Button ID="ProfileImagePlayButton" runat="server" Style="left: 198px; position: absolute; top: 299px" Text="" Width="90px" />
                &nbsp;
                <asp:Button ID="ProfileImageNextButton" runat="server" Style="left: 316px; position: absolute; top: 299px" Text="<%$ Resources:Resource, Next %>" Width="90px" />
                <asp:Button ID="ProfileImageExitButton" runat="server" Style="left: 406px; position: absolute; top: 338px" Text="<%$ Resources:Resource, Close %>" Width="75px" />
                <br />
                <asp:Label ID="TargetedControlLabel" runat="server" Style="left: 715px; position: relative; top: 373px; z-index: 101;" Text=" " Width="33px"></asp:Label>
            ...
            <div id="LoadingDiv" style="height: 100px; left: 0px; position: absolute; top: 0px; width: 100px; z-index: 101">
                <asp:UpdatePanel ID="DelayUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        &nbsp; &nbsp;
                        <asp:Panel ID="LoadingPanel" runat="server" Height="45px" Style="display: none; left: 36px; position: absolute; top: 48px" Width="196px" BackColor="Silver">
                            &nbsp;
                            ...
                            <img src="../../_assets/img/uploading.gif" alt="LoadingImage" style="left: 0px; position: relative; top: -9px" />
                        </asp:Panel>
                        <br />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
            <asp:Panel ID="ExtendProject" runat="server" Height="200px" Style="display: none; left: 45px; position: relative; top: 1850px; width: 174px; z-index: 100;" HorizontalAlign="Center">
            ...
            <asp:Panel ID="MoreProject" runat="server" Height="510px" Style="display: block; left: 48px; position: relative; top: 1218px; z-index: 103;" Width="940px" BackColor="White"
                ...
                <asp:UpdatePanel ID="MoreProjectUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="GlobalPanel" runat="server" Height="370px" Style="left: 5px; position: absolute; top: 9px; z-index: 101;" Width="87%" BackColor="White">
                            <asp:Panel ID="RequirementPanel" runat="server" Height="212px" Style="left: 264px; overflow: hidden; position: absolute; top: 256px" Width="274px" Font-Size="10pt">
                                <table style="height: 100%; left: 0px; position: relative; top: 5px; width: 100%;">
                                    <tr>
                                        <td colspan="2">
                            ...
                            <asp:Panel ID="ProjectSpecificationPanel" runat="server" Height="212px" Style="left: 264px; overflow: hidden; position: absolute; top: 11px" Width="274px">
                                <table style="height: 100%; left: 0px; position: relative; top: 2px; width: 100%;">
                                    <tr>
                                        <td colspan="2">
                            ...
                            <asp:UpdatePanel ID="ProjectPhotoUpdatePanel" runat="server">
                                <ContentTemplate>
                                    <asp:Panel ID="ProjectPhotoPanel" runat="server" Height="270px" Style="left: 15px; overflow: hidden; position: absolute; top: 10px" Width="227px">
                                        ...
                                        <asp:FormView ID="ProjectPhotoFormView" runat="server" AllowPaging="True" DataSourceID="ProjectPhotoObjectDataSource"
                                            ...
                                            <ItemTemplate>
                                                <br />
                                                <table style="height: 200px; width: 227px;">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="PhotoCaptionLabel" runat="server" Style="left: 74px; position: absolute; top: 235px" Height="20px" Text='<%#Bind("Caption")%>'></asp:Label>
                            ...
                            <asp:Panel ID="DescriptionPanel" runat="server" Style="left: 558px; position: relative; top: 13px" Height="457px" Width="358px">
                                ...
                                <asp:TextBox ID="NotesView" runat="server" Height="132px" Style="left: 5px; position: absolute; top: 300px" Width="334px" ReadOnly="True" TextMode="MultiLine"></asp:TextBox>
                                <asp:Label ID="ProjectDescriptionLabel" runat="server" Style="left: 4px; position: absolute; top: 3px" Text="<%$ Resources:Resource, ProjectDescriptionLabel %>" Font-Bold="True"
                                           Font-Size="10pt" ForeColor="Maroon"></asp:Label>
                                <asp:Label ID="DescriptionLabel0" runat="server" Style="left: 4px; position: absolute; top: 28px" Text="<%$ Resources:Resource, DescriptionLabel %>" Font-Bold="True"
                                           Font-Size="10pt" ForeColor="Maroon"></asp:Label>
                                <asp:Label ID="CustomDescriptionLabel" runat="server" Style="left: 5px; position: absolute; top: 50px; z-index: 100;" Height="200px" Width="334px" BackColor="LightGray"></asp:Label>
                                &nbsp;</asp:Panel>
                            ...
                            <asp:Panel ID="LocationPanel" runat="server" Height="130px" Style="left: 15px; overflow: hidden; position: relative; top: -128px" Width="227px">
                                &nbsp;<table style="height: 70%; left: 0px; padding-top: 1%; position: relative; top: 0px; width: 100%;">
                                          <tr>
                                              <td style="width: 100px">
            ...
            <asp:Panel ID="MessageDeletionPanel" runat="server" BackColor="White" Style="display: none; margin-right: 0px" Width="341px" Height="89px" HorizontalAlign="Center" BorderColor="Maroon"
                       BorderWidth="2px">
            ...
            <asp:Panel ID="ModalInvitationPanel" runat="server" Height="420px" Style="display: none; left: 151px; position: relative; top: 317px; z-index: 103;" Width="421px" BackColor="White"
                ...
                <asp:UpdatePanel ID="ModalInvitationUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="GlobalModalInvitationPanel" runat="server" Style="height: 334px; left: 20px; position: relative; top: 11px;" Width="366px">
                            <asp:GridView ID="ModalInvitationGridView" runat="server" AutoGenerateColumns="False"
                                          DataSourceID="CustomerOpenProjectDataSource" Style="left: 0px; position: relative; text-align: center; top: 0px;" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None"
            ...
            <asp:Panel ID="MessagePanel" runat="server" Height="453px" Style="display: none; left: 100px; position: relative; top: 456px; z-index: 105;" Width="480px" BorderStyle="Double"
                ...
                <asp:UpdatePanel ID="MessagePanelUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="MessageLeftPanel" runat="server" Height="28px" Width="131px">
                            <input id="MessageCharacterLeft" value="1000" type="text" style="color: #000080; width: 35px;" />
                        ...
                        <asp:Panel ID="MessageTextBoxFilterationPanel" runat="server" Width="173px" Height="80px"
                                   Style="left: 515px; position: absolute; text-align: center; top: 36px;" BackColor="White">
                            <table cellspacing="1" style="height: 100%; width: 100%;">
                                <tr>
                                    <td style="background-color: Maroon">
            ...
            <asp:Panel ID="ReplyMessagePanel" runat="server" Height="453px" Style="display: none; left: 100px; position: relative; top: 456px; z-index: 100;" Width="480px" BorderStyle="Double"
                       BorderColor="Gray" BorderWidth="3px" BackColor="#cccccc">
                <asp:UpdatePanel ID="ReplyMessageUpdatePanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="ReplyMessageCharacterLeftPanel" runat="server" Height="28px" Width="131px">
                            <input id="ReplyMessageCharacterLeftLabel" value="1000" type="text" style="color: #000080; width: 35px;" />
                        ...
                        <asp:Panel ID="ReplyMessageTextBoxFilterationPanel" runat="server" Width="173px"
                                   Height="80px" Style="left: 515px; position: absolute; text-align: center; top: 36px;"
                                   BackColor="White">
                            <table cellspacing="1" style="height: 100%; width: 100%;">
                                <tr>
                                    <td style="background-color: Maroon">
                        ...
                        <asp:LinkButton ID="ReplyEmailLinkButton" runat="server" CausesValidation="False"
                                        Font-Bold="True" ForeColor="Black" CssClass="UnderlineLink" Style="left: 70%; position: relative; top: 0px" OnClientClick="javascript: $find('ReplyMessageModalPopupExtender').hide();"
                                        Text="<%$ Resources:Resource, SubmitQuestion %>"></asp:LinkButton>
                        <asp:LinkButton ID="CancelReplyEmailLinkButton" runat="server" CausesValidation="False"
                                        Font-Bold="True" ForeColor="Black" CssClass="UnderlineLink" Style="left: 75%; position: relative; top: 0px" OnClientClick="javascript: $find('ReplyMessageModalPopupExtender').hide();"
                                        Text="<%$ Resources:Resource, CancelQuestion %>"></asp:LinkButton>
                        <asp:Label ID="ReplyMessageTargetedLabel" runat="server" Style="position: relative"></asp:Label><br />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </asp:Panel>
            <asp:Panel ID="PayPalPanel" runat="server" Height="420px" Style="display: none; left: 151px; position: relative; top: 317px; z-index: 103;" Width="421px" BackColor="White"
                       BorderStyle="Double" BorderColor="Gray" BorderWidth="3px">
