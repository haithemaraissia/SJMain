<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SignUp.aspx.vb" Inherits="NotAuthenticated.NotAuthenticatedSignUp" %>
    ...
    <head runat="server">
        ...
        <script language="javascript" type="text/javascript">
            function Overflow() {
                ...
                var model = window.$find('ProfessionalPanelModalPopupExtender');
                model.show();
                model.disableTab();
        ...
        function fireanimation() {
            ...
            window.$find('DelayModalPopUpExtender').show();
            document.body.style.overflow = 'visible';
        }
        
        function SetTabIndex() {
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_FirstNameTextBox").tabIndex = 1;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_LastNameTextBox").tabIndex = 2;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_AddressTextBox").tabIndex = 3;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_ZipcodeTextBox").tabIndex = 4;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_CountryDropDownList").tabIndex = 5;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_RegionsDropDownList").tabIndex = 6;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_CitiesDropDownList").tabIndex = 7;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_AgeTextBox").tabIndex = 8;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_GenderDropDownList").tabIndex = 9;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_HomeTelephoneTextBox").tabIndex = 10;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_MobilePhoneTextBox").tabIndex = 11;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_UserName").tabIndex = 12;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_Password").tabIndex = 13;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_ConfirmPassword").tabIndex = 14;
            document.getElementById("SignUpCreateWizard___CustomNav0_CreateUserButton").tabIndex = 20;
            document.getElementById("SignUpCreateWizard___CustomNav0_CancelButton").tabIndex = 21;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_SignInButton").tabIndex = 22;
            document.getElementById("SignUpCreateWizard_CreateUserStepContainer_UserRecoveryHyperLink").tabIndex = 23;
        }
    </script>
    
<script language="javascript" type="text/javascript">
        function pageLoad() {
            var mpeBehaviorhandle = window.$find("mpebehavior");
            mpeBehaviorhandle.add_showing(calledWhenShown);
        }
                ...
                <td>
                    <div style="z-index: 101;">
                        <asp:CreateUserWizard ID="SignUpCreateWizard" runat="server" DisplayCancelButton="True"
                            Height="438px" Width="809px" CancelDestinationPageUrl="Index.aspx" BackColor="White">
                            <WizardSteps>
                                        ...
                                        <table border="0" style="font-size: 100%; width: 928px; height: 481px">
                                            ...
                                            <tr>
                                                <td align="center" colspan="3" style="height: 8px; text-align: left;">
                                                    <div id="GrettingPanel" style="width: 338px; height: 94px">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="RightText">
                                                                        ...
                                                                        <asp:Button ID="SignInButton" runat="server" Font-Size="11pt" Text="<%$ Resources:Resource, SignInButton %>"
                                                                            Width="123px" OnClick="SignInButtonClick" TabIndex="24" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td class="RightText">
                                                                        <asp:HyperLink ID="UserRecoveryHyperLink" runat="server" Font-Size="11pt" NavigateUrl="~/Account/RecoverPassword.aspx"
                                                                            TabIndex="28" Width="246px" Text="<%$ Resources:Resource, ForgotUsername %>"
                                                                ...
                                                                <tr>
                                                                    <td id="customercolumn" runat="server" bgcolor="Maroon">
                                                                        <asp:LinkButton ID="CustomerLinkButton" runat="server" BackColor="Maroon" BorderColor="Maroon"
                                                                            ...
                                                                            ForeColor="White" TabIndex="22" Width="170px" Text="<%$ Resources:Resource, Customer %>"></asp:LinkButton>
                                                                    </td>
                                                                    <td id="professionalcolumn" runat="server">
                                                                        <asp:LinkButton ID="ProfessionalLinkButton" runat="server" BackColor="#003366" BorderColor="#003366"
                                                                            ...
                                                                            OnClientClick="Overflow();" TabIndex="23" Width="170px" Text="<%$ Resources:Resource, professional %>"
                                                                            BorderWidth="3px"></asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <asp:Label ID="RoleLabel" runat="server" Style="position: relative" TabIndex="99"
                                                                Text="<%$ Resources:Resource, Customer %>" Font-Bold="True" ForeColor="Maroon"></asp:Label>
                                                            &nbsp;
                                                        </ContentTemplate>
                                                        <Triggers>
                                            ...
                                            <tr>
                                                <td align="center" colspan="3" style="height: 21px; text-align: left">
                                                    <span style="font-size: 11pt; color: #660000"><strong>
                                                        <asp:Label ID="Step1Label" runat="server" Style="position: relative; font-family: Andy;
                                                            font-size: 13pt;" Text="<%$ Resources:Resource, Step1Label %>" ForeColor="Black"></asp:Label></strong></span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" colspan="5" style="height: 1px; background-color: #E0E0E0" id="step1Column"
                                                    runat="server">
                                                </td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            <asp:TableRow ID="CountryTableRow" runat="server" HorizontalAlign="Center" VerticalAlign="Middle"
                                                                ...
                                                                <asp:TableCell ID="CountryTableCell" runat="server" HorizontalAlign="Center" VerticalAlign="Middle"
                                                                    ...
                                                                    <asp:DropDownList ID="CountryDropDownList" runat="server" AutoPostBack="True" DataSourceID="CountriesDataSource"
                                                                        ...
                                                                        OnSelectedIndexChanged="CountryDropDownListSelectedIndexChanged1" OnChange="fireanimation();">
                                                                    </asp:DropDownList>
                                                                    ...
                                                                    <asp:UpdatePanel ID="RegionUpdatePanel" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <asp:DropDownList ID="RegionsDropDownList" runat="server" AutoPostBack="True" DataSourceID="RegionDataSource"
                                                                                ...
                                                                                OnSelectedIndexChanged="RegionDropDownListSelectedIndexChanged1" OnChange="fireanimation();">
                                                                            </asp:DropDownList>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <span style="font-size: 11pt; color: #660000"><strong>
                                                        <asp:Label ID="Step2Label" runat="server" Style="position: relative; font-family: Andy;
                                                            font-size: 13pt;" Text="<%$ Resources:Resource, Step2Label %>" ForeColor="Black"></asp:Label></strong></span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" colspan="5" style="height: 1px; background-color: #E0E0E0" id="step2Column"
                                                    runat="server">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="3" style="height: 13px">
                                                    <strong><span style="font-size: 11pt; color: #660000">
                                                        <asp:Label ID="Step3Label" runat="server" Style="position: relative; font-family: Andy;
                                                            font-size: 13pt;" Text="<%$ Resources:Resource, Step3label %>" ForeColor="Black"></asp:Label></span></strong>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" colspan="5" style="height: 1px; background-color: #E0E0E0" id="step3Column"
                                                    runat="server">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="7" style="height: 49px; text-align: right">
                                                    ...
                                                    &nbsp;<asp:HyperLink ID="YourSideJobHyperLink" runat="server" Font-Bold="True" NavigateUrl="~/NotAuthenticated/Legal.aspx"
                                            ...
                                            <tr>
                                                <td align="center" colspan="7" style="color: red; text-align: center;">
                                                    ...
                                                    <cc1:ValidatorCalloutExtender ID="EmailExpressionValidatorExtender" runat="server"
                                            ...
                                            <tr>
                                                <td align="center" style="vertical-align: baseline; background-color: White">
                                                    ...
                                                    <asp:Button ID="ContinueButton" runat="server" CausesValidation="False" CommandName="Continue"
                                                        ...
                                                        OnClientClick="fireanimation();" OnClick="ContinueButtonClick" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                        ...
                        <asp:Panel ID="ProfessionalPanel" runat="server" Style="display: none; position: absolute;
                            ...
                            <asp:Panel ID="IndustyPanel" runat="server" Height="56px" Style="left: 3px; position: absolute;
                                ...
                                <asp:DropDownList ID="IndustryDropDownList" runat="server" Style="left: 153px; position: absolute;
                                    ...
                                    DataValueField="CategoryID" AutoPostBack="True" OnChange="fireanimation();" OnSelectedIndexChanged="IndustrySelectedIndexChanged">
                                </asp:DropDownList>
                            ...
                            <asp:Panel ID="RequirementPanel" runat="server" Height="226px" Style="left: 2px;
                                ...
                                <cc1:RoundedCornersExtender ID="RequirementPanelRoundedCornersExtender" runat="server"
                                    BorderColor="64, 0, 0" TargetControlID="RequirementPanel">
                                </cc1:RoundedCornersExtender>
                            ...
                            <asp:Button ID="CancelSkillsButton" runat="server" Style="left: 837px; position: relative;
                                ...
                                BorderWidth="1px"  OnClientClick="SetTabIndex();"/>
                        ...
                        <cc1:ModalPopupExtender ID="ProfessionalPanelModalPopupExtender" runat="server" TargetControlID="ListSkillPanel"
                            PopupControlID="ProfessionalPanel" BackgroundCssClass="modalBackground" BehaviorID ="mpebehavior"  OnOkScript="SetTabIndex();" OnCancelScript="SetTabIndex();" >
                        </cc1:ModalPopupExtender>
                    </div>
                    <cc1:RoundedCornersExtender ID="SignUpCreateWizardRoundedCornersExtender" runat="server"
                        TargetControlID="SignUpCreateWizard" BorderColor="#707070" Radius="5" Color="#707070">
                    </cc1:RoundedCornersExtender>
                </td>
            </tr>
        </table>
    ...
    <div id="LoadingDiv" style="width: 100px; height: 100px; z-index: 200; display: none">
        <asp:UpdatePanel ID="SetTabIndex" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
